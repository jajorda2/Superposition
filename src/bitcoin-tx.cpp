...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cryptobugcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cryptobugcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptobugcoin transaction") + "\n" +
              "  cryptobugcoin-tx [options] -create [commands]   " + _("Create hex-encoded cryptobugcoin transaction") + "\n" +
              "\n";
